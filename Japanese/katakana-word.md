...
| パンケーキ                       | pancake                   | 松饼                     |
| ハンサム                         | handsome                  |                          |
| バンジージャンプ                 | bungy jump                | 蹦极                     |
| パンチ                           | punch                     | 拳击；简洁有力           |
| パンツ                           | pants                     | 内裤                     |
| ハンディ（キャップ）             | handicap                  | （比赛中）让步，不利条件 |
| ハンド                           | hand                      |                          |
| ハンドルネーム                   | handle + name             | （社交网络上的）用户名   |
| ハンディー                       | handy                     |                          |
| パンデミック                     | pandemic                  |                          |
| バンド                           | band                      |                          |
| ハンドバッグ                     | handbag                   |                          |
| ハンドル                         | handle                    | 方向盘                   |
| ハンバーグ（ステーキ）           | Hamburg steak             | 汉堡肉                   |
| ハンマー                         | hammer                    |                          |
| ピアノ                           | （イタリア）piano         |                          |
| ヒアリング                       | hearing                   | 听力                     |
| ピース                           | peace                     |                          |
...
| フィールド                       | field                     |                          |
| フィギュア                       | figure                    | 手办                     |
| フィクション                     | fiction                   | 小说；虚构               |
| フィジカル                       | physical                  |                          |
| フィッシング                     | fishing                   |                          |
| フィットネス                     | fitness                   | 健身                     |
| フィナーレ                       | （イタリア）finale        | 最后一幕；终曲           |
| フィルター                       | filter                    |                          |
| フィルム                         | film                      |                          |
| ブーイング                       | booing                    | 嘘声                     |
| フーズ                           | foods                     |                          |
...
| プレーン                         | plane                     |                          |
| フレキシブル                     | flexible                  |                          |
| フレキシビリティー               | flexiblity                |                          |
| プレス                           | press                     | 熨；印刷，出版           |
| プレゼン（テーション）           | presentation              |                          |
| プレゼント                       | present                   | 礼物                     |
| フレックスタイム                 | flextime                  | 弹性时间                 |
| プレッシャー                     | pressure                  | 压力                     |
...
| プロトタイプ                     | prototype                 |                          |
| プロバイダー                     | provider                  |                          |
| プロファイル・プロフィール       | profile                   |                          |
| プロ（フェッショナル）           | professional              |                          |
| プロポーズ                       | propose                   | 求婚                     |
| プロモーション                   | promotion                 |                          |
| プロローグ                       | prologue                  |                          |
...
| マスク                     | mask                | 口罩                |
| マスコット                 | mascot              | 吉祥物              |
| マスコミ（ュニケーション） | mass communication  | 大众传媒            |
| マスター                   | master              |                     |
| マゼンタ                   | magenta             | 品红                |
| マゾヒズム                 | masochist           | 受虐狂              |
| マダム                     | madam               |                     |
