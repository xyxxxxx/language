...
| クリアランス[2]                 | clearance                    |                        |
| クリアランスセール[7]           | clearance sale               | 清仓大甩卖             |
| グリース[2]                     | grease                       | 润滑油                 |
| クリーニング[4][2]              | cleaning                     |                        |
| クリーム[2]                     | cream                        |                        |
| クリーン[2]                     | clean                        |                        |
...
| ダブリュー[1]                      | W                      |                              |
| ダブル[1]                          | double                 |                              |
| ダブルカフス[4]                    | double cuffs           | 双层袖口                     |
| ダブルカラー[4]                    | double collar          | 翻领                         |
| ダブルス[1]                        | doubles                | 双打                         |
| ダブルスタンダード[7]              | double standard        |                              |
| ダブルチェック[4]                  | double check           |                              |
| タブレット[1]                      | tablet                 | 平板电脑                     |
| タペストリー[2][1]                 | tapestry               | 挂画                         |
| ダミー[1]                          | dummy                  | 替身                         |
| ダム[1]                            | dam                    |                              |
| ダメージ[2][1]                     | damage                 |                              |
| タルト[1]                          | （フランス）tarte      | 挞                           |
...
| タン[1]                            | tongue                 | 牛舌                         |
| タンク[1]                          | tank                   |                              |
| タンクトップ[4]                    | tank top               | 背心                         |
| ダンス[1]                          | dance                  |                              |
| タンバリン[1]                      | tambourine             | 铃鼓                         |
| ダンピング[1]                      | dumping                | 倾销                         |
| ダンプ                             | dump                   |                              |
| ダンプ（カー）                     | dump + car             | 自动卸货卡车                 |
| ダンボール[3]                      |                        | 箱子                         |
| チーズ[1]                          | cheese                 |                              |
| チーフ[1]                          | chief                  | 首领                         |
| チーム[1]                          | team                   |                              |
...
| チンパンジー[3]                    | chimpanzee             | 黑猩猩                       |
| チンピラ                           |                        | 小混混                       |
| ツアー[1]                          | tour                   |                              |
| ツー[1]                            | two                    |                              |
| ツーショット[3]                    | two + shot             | 两人合照                     |
| ツール[1]                          | tool                   |                              |
| ツナ[1]                            | tuna                   | 金枪鱼；金枪鱼罐头           |
| ティアラ[1]                        | tiara                  | 头冠                         |
| ティー[1]                          | T                      |                              |
...
| ディープ[1]                        | deep                   |                              |
| ディーラー[1]                      | dealer                 |                              |
| ティシュ（ペーパー）[1]            | tissue paper           |                              |
| ディス[1]                          | diss                   |                              |
| ディスカウント[3]                  | discount               |                              |
| ディスカス[3]                      | discus                 |                              |
| ディスカッション[3]                | discussion             |                              |
| ディスカバー[3]                    | discover               |                              |
| ディスク[1]                        | disc                   |                              |
...
| ディベート[2]                      | debate                 |                              |
| ディベロッパー[3]                  | developer              |                              |
| ティラミス[1]                      | （イタリア）tiramisù   | 提拉米苏                     |
| ディレクター[2]                    | director               |                              |
| デー[1]                            | day                    |                              |
| テークアウト[4]                    | take out               | 外带                         |
| テースト[1]                        | taste                  |                              |
| テータ[1]                          | theta                  |                              |
| データ[1]                          | data                   |                              |
| データセット[4]                    | dataset                |                              |
...
| テーブル                           | table                  |                              |
| テーマ[1]                          | （ドイツ）Thema        |                              |
| テーマソング[4]                    | （ドイツ）Thema + song |                              |
| テーマパーク[4]                    | thema park             | 主题公园                     |
| デーモン[1]                        | demon                  |                              |
| デーリー[1]                        | daily                  |                              |
| テール[1]                          | tail                   |                              |
| テキーラ[2]                        | （スペイン）tequila    | 龙舌兰                       |
| テキスト[1][2]                     | text                   | 文本；课文                   |
| テキストブック[5]                  | textbook               |                              |
| テクスチャー[1]                    | texture                |                              |
| テク（ニック）[1]                  | technic                |                              |
| テク（ノロジー）[1]（[3]）         | technology             |                              |
| デコーダー[2]                      | decoder                |                              |
| デコード[2]                        | decode                 |                              |
| デコラティブ[2]                    | decorative             |                              |
| デコ（レーション）[1]（[3]）       | decoration             |                              |
| デザート[2]                        | dessert                |                              |
| デザイナー[2]                      | designer               |                              |
| デザイン[2]                        | design                 |                              |
| デジタル                           | digital                |                              |
...
| デスクトップ[4]                    | desktop                |                              |
| テスト[1]                          | test                   |                              |
| テストステロン[5]                  | testosterone           | 睾酮                         |
| デスペレート[4]                    | desperate              |                              |
| デスマッチ[3]                      | death + match          | 死斗                         |
| テスラ[1]                          | Tesla                  |                              |
...
| テニス[1]                          | tennis                 |                              |
| デニム[1]                          | denim                  | 牛仔裤                       |
| デパートメントストア[2]（[9]）     | department store       | 百货店                       |
| デバイス[2][0]                     | device                 |                              |
| デビットカード[5]                  | debit card             |                              |
| デビュー[1]                        | （フランス）début      | 出道                         |
| デフォルト[2]                      | default                |                              |
| デブリ[1]                          | （フランス）débris     | 碎片                         |
| デフレ（ーション）（[3]）          | deflation              | 通货紧缩                     |
| デプレッション[3]                  | depression             |                              |
| デフロスター[3]                    | defroster              |                              |
| デベロッパー[3]                    | developer              |                              |
| デポジット[3][2]                   | deposit                | 保证金                       |
| デメリット[2]                      | demerit                |                              |
| デモクラシー[4][2]                 | democracy              |                              |
| デモクラティック[5]                | democratic             |                              |
| デモグラフィー[3]                  | demography             |                              |
| デモ（ンストレーション）[1]（[6]） | demonstration          | 示威游行                     |
| テラリウム[3]                      | terrarium              | 陆地箱                       |
| デリカシー[2]                      | delicacy               | 纤细                         |
| デリケート[3]                      | delicate               | 精致；微妙；纤细             |
| テリトリー[1]                      | teritory               |                              |
| デリバリー[2]                      | delivery               |                              |
| デルタ[1]                          | delta                  |                              |
| テレパシー[2]                      | telepathy              | 心电感应                     |
| テレビゲーム[4]                    | television + game      |                              |
| テレビ（ジョン）[1]（[3]）         | television             |                              |
| テレホン[1]                        | telephone              |                              |
| テロ（リズム）[1]                  | terrorism              |                              |
| テロリスト[1]                      | terrorist              |                              |
| テン[1]                            | ten                    |                              |
...
| トマト[1]                          | tomato                 |                              |
| ドメイン[2]                        | domain                 |                              |
| ドメスティック[4][2]               | domestic               |                              |
| トライ[2]                          | try                    |                              |
| ドライ[2]                          | dry                    | 冷淡，冷漠                   |
| トライアスロン[5]                  | triathlon              | 铁人三项                     |
| トライアル[2]                      | trial                  | 预赛                         |
| トライアングル[4]                  | triangle               |                              |
| ドライクリーニング[5][7]           | dry cleaning           |                              |
| ドライバー[2][0]                   | driver                 | 司机；螺丝刀，改锥；驱动程序 |
| ドライブ[2]                        | drive                  |                              |
| ドライヤー[0][2]                   | dryer                  | 吹风机                       |
| トラウマ[2]                        | （ドイツ）Trauma       | 精神创伤                     |
| トラクター[2]                      | tractor                | 收割机                       |
| トラック[2]                        | truck                  | 卡车                         |
|                                    | track                  | 音轨                         |
| ドラッグ[2]                        | drug                   | 毒品                         |
|                                    | drag                   |                              |
| ドラッグストア[6]                  | drugstore              | 药店                         |
| トラップ[2]                        | trap                   |                              |
| トラディション[3]                  | tradition              |                              |
| トラフィック[3]                    | traffic                |                              |
| トラブル[2]                        | trouble                |                              |
...
| ドラマ[1]                          | drama                  |                              |
| ドラマチック[4]                    | dramatic               |                              |
| ドラマツルギー[4]                  | （ドイツ）Dramaturgie  | 戏剧理论                     |
| ドラム[1]                          | drum                   |                              |
...
| トレード[2][0]                     | trade                  |                              |
| トレードオフ[5]                    | trade-off              |                              |
| トレーナー[2][0]                   | trainer                | 教练员                       |
| トレーニング[2]                    | training               |                              |
| トレーラー[2][0]                   | trailer                | 板车                         |
| トレカ                             |                        | （类似大头贴的）照片         |
| ドレス[1]                          | dress                  | 女士礼服                     |
| トレンド[2][0]                     | trend                  |                              |
| ドロー[2]                          | draw                   |                              |
...
| ナノテク（ノロジー）[1]（[5][6]） | nanotechnology    |                                                      |
| ナビ（ゲーション）[1]（[3]）      | navigation        |                                                      |
| ナプキン[1]                       | napkin            | 餐巾，纸巾                                           |
| ナルシシスト[4]                   | narcissist        |                                                      |
| ナルシシズム[4]                   | narcissism        |                                                      |
...
| ニグロ[1]                         | Negro             |                                                      |
| ニッケル                          | nickel            | 镍                                                   |
| ニヒリズム[3]                     | nihilism          | 虚无主义                                             |
| ニュアンス[1]                     | nuance            | 语言的微妙差别                                       |
| ニュー[1]                         | new               |                                                      |
| ニュース[1]                       | news              |                                                      |
...
| バー[1]                                 | bar                       |                          |
| パーキング[1][0]                        | parking                   |                          |
| パーキンソン                            | Parkinson                 | 帕金森                   |
| パーク[1]                               | park                      |                          |
| バーゲン[1]                             | bargain                   |                          |
| バーコード[3]                           | bar code                  | 条形码                   |
| パーシャル[1]                           | partial                   |                          |
| バージョン[1]                           | version                   |                          |
| バージン[1]                             | virgin                    |                          |
| バース[1]                               | verse                     |                          |
...
| パーソナル[1]                           | personal                  |                          |
| パーソナルコンピューター[8]（パソコン） | personal computer         |                          |
| バーター[1]                             | barter                    | 以物易物                 |
| バーチャル[1]                           | virtual                   |                          |
...
| パーツ[1][0]                            | parts                     |                          |
| パーティー[1]                           | party                     |                          |
| バーテン（ダー）[0]（[3]）              | bartender                 | 调酒师                   |
| ハート                                  | heart                     |                          |
| ハード[1]                               | hard                      |                          |
| ハードウェア[5]                         | hardware                  |                          |
| ハードコア[4]                           | hardcore                  |                          |
| パート[1]                               | part                      |                          |
| パートタイマー[4]                       | part-timer                |                          |
| パート（タイム）（[4]）                 | part time                 |                          |
| ハードディスク[4]                       | hard disk                 |                          |
| パートナー[1]                           | partner                   |                          |
| パートナーシップ[6]                     | partnership               |                          |
| ハードボイルド[4]                       | hard-boiled               | 无情，冷酷，硬派         |
| ハードル                                | hurdle                    | 跨栏；困难               |
| ハーフ[1]                               | half                      |                          |
| ハープ[1]                               | harp                      | 竖琴                     |
| ハーブ[1]                               | herb                      |                          |
...
| バイク[1]                               | bike                      | 摩托车；自行车           |
| ハイジャック[3]                         | hijack                    | 劫机                     |
| ハイスペック[4]                         | high spec                 | 高性能；高富帅，白富美   |
...
| バクテリア                              | bacteria                  |                          |
| ハザード[2][1]                          | hazard                    |                          |
| バザール[2]                             | （フランス）bazar         | 巴扎                     |
| パジャマ[1]                             | pajamas                   |                          |
| パス[1]                                 | pass                      |                          |
| バス[1]                                 | bath                      |                          |
| [1]                                     | bus                       |                          |
| ハスキー[1]                             | husky                     | 沙哑                     |
| パスタ[1]                               | （イタリア）pasta         | 意式面食                 |
| バスト[1]                               | bust                      | 胸围；半身像             |
| パスポート[3]                           | passport                  |                          |
| パズル[1]                               | puzzle                    |                          |
| バスルーム[3]                           | bathroom                  |                          |
...
| バック[1]                               | back                      |                          |
| バッグ[1]                               | bag                       |                          |
| バックアップ[4]                         | back up                   | 后援，支援；备份         |
| バックグラウンド[5]                     | background                |                          |
| バックグラウンドミュージック[9]         | background music          |                          |
| バックストローク[6]                     | backstroke                | 仰泳                     |
| バックナンバー[4]                       | back number               | 过期杂志                 |
| バックパッカー[4]                       | backpacker                | 背包客                   |
| バックハンド[4]                         | backhand                  | 反手                     |
| バックボーン[4]                         | backbone                  | 脊梁；骨气；骨干，基干   |
| パッケージ[1]                           | package                   | 包装                     |
| バッジ[1]                               | badge                     |                          |
| パッション[1]                           | passion                   |                          |
...
| ハッピー[1]                             | happy                     |                          |
| ハッピーエンド[5]                       | happy end                 |                          |
| パト（ロール）カー[3][2]                | patrol car                | 巡逻车，警车             |
| バトル[1]                               | battle                    |                          |
| パトロール[3]                           | patrol                    |                          |
| パトロン[0][1]                          | patron                    |                          |
| バナジウム[3]                           | vanadium                  | 钒                       |
| バトン[0]                               | baton                     | 接力棒；指挥棒           |
| バトンタッチ[4]                         | baton + touch             | 交接                     |
| バニラ[1]                               | vanilla                   | 香草                     |
| バナナ[1]                               | banana                    |                          |
| パニック[1][2]                          | panic                     |                          |
| バニティー[1]                           | vanity                    |                          |
...
| パラサイト[1]                           | parasite                  |                          |
| パラジウム[3]                           | palladium                 | 钯                       |
| パラシュート[3]                         | parachute                 | 降落伞                   |
| パラソル[1][0]                          | （フランス）parasol       | 遮阳伞                   |
| パラダイス[1][3]                        | paradise                  |                          |
| パラダイム[3]                           | paradigm                  |                          |
| パラドックス[3]                         | paradox                   | 悖论                     |
| ハラミ                                  |                           | 横膈膜肉                 |
...
| バンカー[1]                             | banker                    |                          |
| バンカー[1]                             | bunker                    |                          |
| ハンカチーフ[3][0]（[4]）               | handkerchief              |                          |
| パンク                                  | puncture                  | 爆胎                     |
| パンク[1]                               | punk                      |                          |
| ハングリー[1]                           | hungry                    |                          |
| パンケーキ[3]                           | pancake                   | 松饼                     |
| ハンサム[1]                             | handsome                  |                          |
| バンジージャンプ[5]                     | bungy jump                | 蹦极                     |
| パンチ[1]                               | punch                     | 拳击；简洁有力           |
| パンツ[1]                               | pants                     | 内裤                     |
| ハンディ（キャップ）[4]                 | handicap                  | （比赛中）让步，不利条件 |
| パンテオン                              | Pantheon                  |                          |
| ハンド[1]                               | hand                      |                          |
| バンド                                  | band                      |                          |
| ハンドルネーム[5]                       | handle + name             | （社交网络上的）用户名   |
| パンティー[1]                           | pantie; panty             | 女式三角裤               |
| ハンディー[1]                           | handy                     |                          |
| パンデミック                            | pandemic                  |                          |
| ハンドバッグ[4]                         | handbag                   |                          |
| ハンドブック[4]                         | handbook                  |                          |
| ハンドボール[4]                         | handball                  |                          |
| パントマイム[4]                         | pantomime                 | 哑剧，默剧               |
| ハンドル                                | handle                    | 方向盘                   |
| ハンバーグ（ステーキ）[3]（[7]）        | Hamburg steak             | 汉堡肉                   |
| ハンマー[1]                             | hammer                    |                          |
| ピアノ                                  | （イタリア）piano         |                          |
| ヒアリング[1][0]                        | hearing                   | 听力                     |
| ピー[1]                                 | P                         |                          |
| ビー[1]                                 | B                         |                          |
| ピース[1]                               | peace                     |                          |
| [1]                                     | piece                     |                          |
...
| ヒーロー[1]                             | hero                      |                          |
| ビーンズ[1]                             | beans                     |                          |
| ヒエラルヒー・ヒエラルキー[3]           | （ドイツ）Hierarchie      | 等级制度                 |
| ピエロ[1]                               | （仏）pierrot             | 小丑                     |
| ヒエログリフ[4]                         | hieroglyph                | 象形文字                 |
| ビギナー[1]                             | beginner                  |                          |
| ビキニ                                  | bikini                    |                          |
| ピクセル[1]                             | pixel                     |                          |
| ピクニック[1][3]                        | picnic                    |                          |
...
| ビジネス[1]                             | business                  |                          |
| ビジョン[1]                             | vision                    | 理想；幻想               |
| ピスタチオ[3]                           | （イタリア）pistàcchio    | 开心果                   |
| ヒステリー[3][4]                        | （ドイツ）Hysterie        | 歇斯底里                 |
| ヒステリック[4]                         | hysteric                  | 歇斯底里                 |
| ヒストグラム[4]                         | histogram                 | 直方图                   |
| ヒストリー[1]                           | history                   |                          |
| ピストル                                | pistol                    |                          |
| ピストン[1]                             | piston                    |                          |
| ビタミン[2]                             | （ドイツ）Vitamin         |                          |
...
| ビップ[1]                               | VIP                       |                          |
| ビデオ[1]                               | video                     | 录影机；录影带           |
| ビデオカメラ[4]                         | video camera              | 摄像机                   |
| ビデオゲーム[4]                         | video game                |                          |
| ビデオテープ[4]                         | videotape                 |                          |
| ビニール[2]                             | vinyl                     | 塑料                     |
| ビニールハウス[5]                       | vinyl + house             | 温室                     |
| ビネガー[1]                             | vineager                  | 洋醋                     |
| ビヘイビア[2]                           | behavior                  |                          |
| ピペット[2][1]                          | pipette                   | 移液管                   |
| ピュア[1]                               | pure                      |                          |
| ビュー[1]                               | view                      |                          |
| ビューアー[1]                           | viewer                    |                          |
| ヒューズ[1]                             | fuse                      | 保险丝                   |
| ヒューマニズム[4]                       | humanism                  | 人道主义                 |
| ヒューマニティー[3]                     | humanity                  |                          |
| ヒューマン[1]                           | human                     |                          |
| ヒューマンリソース[6]                   | human resources           |                          |
| ピューリタン[1][3]                      | Puritan                   | 清教徒                   |
| ビューロー[1]                           | bureau                    |                          |
| ビューロクラシー[4]                     | bureaucracy               |                          |
| ビュッフェ[1]                           | （仏）buffet              | 自助餐                   |
| ビラ                                    |                           | 传单                     |
| ピリオド[1]                             | period                    | 句号；终止               |
| ビリオネア[3]                           | billionaire               |                          |
| ビリオン[1]                             | billion                   |                          |
...
| ファイル[1]                             | file                      |                          |
| ファクト[1]                             | fact                      |                          |
| ファゴット[1][2]                        | （イタリア）fagotto       | 大管                     |
| ファシスト[2]                           | fascist                   |                          |
| ファシズム[2]                           | fascism                   |                          |
| ファスナー[1]                           | fastener                  |                          |
| ファック[1]                             | fuck                      |                          |
| ファッション[1]                         | fashion                   |                          |
| ファミ（リー）レス（トラン）（[5]）     | family restaurant         |                          |
| ファン[1]                               | fan                       |                          |
| ファンシー[1]                           | fancy                     |                          |
| ファンタジー[1]                         | fantasy                   |                          |
| ファンタスティック[5]                   | fantastic                 |                          |
| ファンダメンタル[4]                     | fundamental               |                          |
...
| ブーム[1]                               | boom                      | 风潮，流行               |
| プール[1]                               | pool                      |                          |
| フェア[1]                               | fair                      | 公平，公正；展览会       |
| フェアリー[1]                           | fairy                     |                          |
| フェアリーテール[5]                     | fairy tale                |                          |
| フェイシャル[1]                         | facial                    |                          |
| フェーク[1]                             | fake （=偽物）            | 虚假，假货               |
| フェース[1]                             | face                      |                          |
| フェースパック[4]                       | face + pack               | 面膜                     |
| フェードイン[4]                         | fade in                   |                          |
| フェードアウト[4]                       | fade out                  |                          |
| フェスティバル[1]                       | festival                  |                          |
| フェティシズム[3]・フェチ               | fetishism                 | 恋物癖                   |
| フェデレーション[3]                     | federation                |                          |
| フェミニスト[3]                         | feminist                  | 女权主义者               |
| フェミニズム[3]                         | feminism                  | 女权主义                 |
| フェラ（チオ）                          | fellatio                  | 口交                     |
| フェリー[1]                             | ferry                     | 渡轮                     |
| フェローシップ[4]                       | fellowship                |                          |
| フェロモン[1]                           | pheromone                 | 信息素                   |
| フェンス[1]                             | fence                     |                          |
| フォー[1]                               | four                      |                          |
| フォーカス[1]                           | focus                     |                          |
| フォーク[1]                             | fork                      |                          |
...
| フォトン[1]                             | photon                    | 光子                     |
| フォルダー[1]                           | folder                    |                          |
| フォルテ[1]                             | （イタリア）forte         | 强音                     |
| フォロー[1]                             | follow                    |                          |
| フォローアップ[4]                       | follow-up                 | 追踪调查                 |
| フォロワー[1]                           | follower                  | 粉丝                     |
| フォワード[0][2]                        | forward                   |                          |
| フォント[1]                             | font                      | 字体                     |
| ブザー[1]                               | buzzer                    | 蜂鸣器                   |
...
| ブックマーク[4]                         | bookmark                  |                          |
| プッシュ[1]                             | push                      |                          |
| ブティック[1][2]                        | （フランス）boutique      | 服装店，时装店           |
| プディング[1]                           | pudding                   |                          |
| フライ[0][2]                            | fry                       |                          |
| [2]                                     | fly                       |                          |
| プライオリティー[4]                     | priority                  |                          |
| ブライダル[2]                           | bridal                    | （西式）婚礼             |
| フライデー[2]                           | Friday                    |                          |
| フライト                                | flight                    |                          |
| プライド                                | pride                     |                          |
| ブライド[2]                             | bride                     |                          |
...
| フラッシュメモリ[5]                     | flash memory              | 闪存                     |
| フラット[2]                             | flat                      |                          |
| プラットフォーム・プラットホーム[5]     | platform                  |                          |
| プラトン                                | Platōn                    | 柏拉图                   |
| プラトニックラブ[7]                     | Platonic love             |                          |
| フラワー[2]                             | flower                    |                          |
| プラン[1]                               | plan                      |                          |
| プランター[2][0]                        | planter                   | 花盆                     |
| ブランチ[2]                             | branch                    |                          |
| [2]                                     | brunch                    |                          |
| フランチャイズ[4]                       | franchise                 | 专营权                   |
| ブランデー[0][2]                        | brandy                    | 白兰地                   |
| ブランド                                | brand                     |                          |
| プラント[0][2]                          | plant                     |                          |
| プランナー[2][0]                        | planner                   |                          |
| プランニング[2]                         | planning                  |                          |
...
| フリーウエー[5]                         | freeway                   |                          |
| フリーク[2]                             | freak                     | 怪胎；狂热者             |
| フリーター・フリーアルバイター[6]       | free + （ドイツ）Arbeiter | 自由职业者               |
| フリーザー[2]                           | freezer                   |                          |
| フリーズ[2]                             | freeze                    |                          |
| プリーズ[2]                             | please                    |                          |
| フリーダム[2]                           | freedom                   |                          |
...
| ブリーフ                                | brief                     | 男用三角内裤             |
| ブリーフィング[2]                       | briefing                  |                          |
| フリーマーケット[4]                     | flea market               | 跳蚤市场                 |
| フリーランサー[4]                       | freelancer                | 自由职业者               |
| ブリキ                                  | （オランダ）blik          | 铁皮                     |
| フリクション[2]                         | friction                  |                          |
| プリクラ                                |                           | 大头贴                   |
| ブリッジ[2]                             | bridge                    |                          |
...
| フルート[2]                             | flute                     | 长笛                     |
| プルートー                              | Pluto                     |                          |
| プルトニウム[4]                         | plutonium                 | 钚                       |
| ブルマー[1][2]                          | bloomer                   | 女式运动短裤             |
| プレー[2]                               | play                      |                          |
| プレーオフ[4]                           | play-off                  |                          |
| ブレーカー[2][0]                        | breaker                   | 电闸                     |
| ブレーキ[2][0]                          | brake                     | 刹车                     |
| フレーク[2]                             | flake                     |                          |
...
| [2]                                     | plain                     |                          |
| フレキシブル[2]                         | flexible                  |                          |
| フレキシビリティー[5]                   | flexiblity                |                          |
| プレキャストコンクリート[9]             | precast concrete          | 预制混凝土               |
| フレグランス[2]                         | fragrance                 |                          |
| プレジデント[2]                         | president                 |                          |
| プレス[1][2]                            | press                     | 熨；印刷，出版           |
| プレスティージ[4]                       | prestige                  |                          |
| ブレスト[2]                             | breast                    |                          |
| プレゼン（テーション）（[5]）           | presentation              |                          |
| プレゼント[2]                           | present                   | 礼物                     |
| フレックスタイム[6]                     | flextime                  | 弹性时间                 |
| プレッシャー[2][0]                      | pressure                  | 压力                     |
| プレミア（ム）                          | premium                   | 加价；赠品               |
| フレンチ                                | French                    |                          |
| フロア[2]                               | floor                     |                          |
| ブローカー[2][0]                        | broker                    | 经纪人，中间人           |
| フローズン[2]                           | frozen                    |                          |
| ブローチ[2]                             | brooch                    | 胸针                     |
| フロート[2][0]                          | float                     |                          |
| ブロードウェー                          | Broadway                  |                          |
...
| プロダクト[3]                           | product                   |                          |
| ブロック[2]                             | block                     | 块，水泥/混凝土块；街区  |
| プロテイン[3]                           | protein                   |                          |
| プロテクター[3]                         | protector                 | 护具                     |
| プロテクト[3]                           | protect                   |                          |
| プロテスト[3]                           | protest                   |                          |
| プロデューサー[3]                       | producer                  |                          |
| プロデュース[3]                         | produce                   | （影视）制作             |
| プロトコル[3][2]                        | protocol                  |                          |
| プロトタイプ[4]                         | prototype                 |                          |
| プロパー[2]                             | proper                    |                          |
| プロバイダー[3]                         | provider                  |                          |
| プロファイル・プロフィール[3]           | profile                   |                          |
| プロフィット[3]                         | profit                    |                          |
| プロフェッサー[3]                       | professor                 |                          |
| プロブレム[2]                           | problem                   |                          |
| プロ（フェッショナル）[1]（[3]）        | professional              |                          |
| プロポーズ[3]                           | propose                   | 求婚                     |
| プロモーション[3]                       | promotion                 |                          |
| プロモーター[3]                         | promoter                  |                          |
| プロモート[3]                           | promote                   |                          |
| プロローグ[3]                           | prologue                  |                          |
| ブロンズ[0]                             | bronze                    |                          |
| フロンティア[2]                         | frontier                  | 边境；前沿               |
| フロント                                | front                     | 前台                     |
| へア[1]                                 | hair                      |                          |
| ペア[1]                                 | pair                      |                          |
|                                         | pear                      |                          |
| ヘアスタイル[4]                         | hairstyle                 |                          |
| ヘアダイ[3]                             | hairdye                   | 染发，染发剂             |
| ヘアドライヤー[4]                       | hair dryer                | 吹风机                   |
| へアピン                                | hairpin                   |                          |
| ヘアピンカーブ[5]                       | hairpin + curve           | 发夹弯                   |
| ペアルック[3]                           | pair + look               | 情侣装                   |
| ペイント                                | paint                     |                          |
| ベーカリー[1]                           | bakery                    |                          |
| ページ[1]                               | page                      |                          |
| ベーシック[1][3]                        | basic                     |                          |
...
| ベータ[1]                               | beta                      |                          |
| ペーパー[0][1]                          | paper                     | 论文                     |
| ペーパーカンパニー[5]                   | paper + company           | 皮包公司                 |
| ペーパーテスト[5]                       | paper + test              | 笔试                     |
| ヘクタール[3]                           | （フランス）hectare       | 公顷                     |
| ベクトル[1]                             | vector                    |                          |
| ペシミスティック[5][3]                  | pessimistic               |                          |
| ペシミスト[3]                           | pessimist                 |                          |
| ペシミズム[3]                           | pessimism                 |                          |
| ベスト[1]                               | best                      |                          |
| [1]                                     | vest                      |                          |
| ベストセラー[4]                         | best-seller               | 畅销书                   |
| ペダル                                  | pedal                     | 踏板                     |
| ペット[1]                               | pet                       |                          |
| ベット[1]                               | bet                       |                          |
| ベッド[1]                               | bed                       |                          |
| ヘッドセット[4]                         | headset                   | 头戴式耳机               |
| ヘッドフォン                            | headphone                 | 头戴式耳机               |
| ペットボトル[4]                         | PET bottle                | 塑料瓶                   |
| ベテラン                                | veteran                   |                          |
| ペナルティー[2]                         | penalty                   |                          |
| ヘビー[1]                               | heavy                     |                          |
| ベビー[1]                               | baby                      |                          |
| ベビーカー[4]                           | baby + car                | 婴儿车                   |
| ベビーブーム[4]                         | baby boom                 |                          |
| ベビーフェース[4]                       | baby face                 |                          |
| ベランダ                                | veranda                   | 阳台                     |
| ヘリ（コプター）[1]（[3]）              | helicopter                |                          |
| ヘリウム[2]                             | helium                    | 氦                       |
| ベリリウム[3]                           | beryllium                 | 铍                       |
| ベル[1]                                 | bell                      |                          |
| ヘルシー[1]                             | healthy                   |                          |
| ヘルス[1]                               | health                    | 健康；大保健             |
| ペルソナ[0][2]                          | （ラテン）persona         | 假面；人格               |
| ベルト                                  | belt                      |                          |
| ヘルニア                                | （ラテン）hernia          | 疝，突出                 |
| ヘルプ[1]                               | help                      |                          |
| ヘロイン[2]                             | heroin                    | 海洛因                   |
| ペン[1]                                 | pen                       |                          |
| ペンキ                                  | （オランダ）pek           | 油漆                     |
...
| ベンチ[1]                               | bench                     |                          |
| ベンチマーク[4]                         | benchmark                 |                          |
| ベンチャー[1]                           | venture                   | 风险，风险企业           |
| ベンチャーキャピタル[5]                 | venture capital           |                          |
| ペンネ[1]                               | （イタリア）penne         | 直通粉                   |
| ペンネーム[3]                           | pen name                  |                          |
| ボイコット[3]                           | boycott                   |                          |
| ボイス[1]                               | voice                     |                          |
| ホイッスル[2]                           | whistle                   | 口哨                     |
...
| ボード[1][0]                            | board                     |                          |
| ボードゲーム[4]                         | board game                |                          |
| ポートフォリオ[4]                       | portfolio                 | 投资组合                 |
| ボーナス[1]                             | bonus                     |                          |
| ホープ[1]                               | hope                      |                          |
| ホーム[1]                               | home                      |                          |
| ホームページ[4]                         | homepage                  |                          |
| ホームレス[1]                           | homeless                  | 流浪汉                   |
| ホール[1]                               | hall                      |                          |
| [1]                                     | hole                      |                          |
| ボール                                  | ball                      |                          |
| ホールド[1]                             | hold                      |                          |
...
| ポシェット[2][1]                        | （フランス）pochette      | 挎包                     |
| ポジション[2]                           | position                  |                          |
| ボス[1]                                 | boss                      | 老板；头目               |
| ポスター[1]                             | poster                    |                          |
| ホステス[1]                             | hostess                   | 陪酒女，女公关           |
| ホスト[1]                               | host                      | 牛郎，男公关             |
| ポスト[1]                               | post                      |                          |
| ポタージュ[2]                           | （フランス）potage        | 浓汤                     |
| ボタン                                  | （ポルトガル）botão       | 纽扣                     |
| ボックス[1]                             | box                       |                          |
| ホ（ッ）チキス[1]                       | （商标）Hotchikiss        | 订书机                   |
| ポット[1]                               | pot                       | 水壶                     |
| ポッドキャスト[4]                       | podcast                   |                          |
| ホットスポット[5]                       | hot spot                  | 热点                     |
| ホットドッグ[4]                         | hot dog                   |                          |
| ホットパンツ[4]                         | hot pants                 | 热裤                     |
| ホットマネー[4]                         | hot money                 |                          |
| ホットライン[4]                         | hot line                  |                          |
| ポップ[1]                               | pop                       |                          |
| ポップコーン[4]                         | popcorn                   |                          |
...
| ポテンシャル[2]                         | potential                 |                          |
| ボトル[1]                               | bottle                    | 水瓶                     |
| ボトルネック[4]                         | bottleneck                | 瓶颈                     |
| ホバリング                              | hovering                  |                          |
| ホビー[1]                               | hobby                     |                          |
| ポピュラー[1]                           | popular                   |                          |
| ポピュラリティ[3]                       | popularity                |                          |
| ポピュレーション[3]                     | population                |                          |
| ホモ（セクシュアル）[1]（[3]）          | homo(sexual)              | 男同性恋                 |
| ボランティア[2]                         | volunteer                 |                          |
| ポリエステル[3]                         | polyester                 | 聚酯                     |
| ポリ（エチレン）[3][0]                  | polyethylene              | 聚乙烯                   |
| ポリグラフ[3]                           | polygraph                 | 测谎仪                   |
| ポリシー[1]                             | policy                    |                          |
| ボリューム                              | volume                    |                          |
| ボルテージ[3]                           | voltage                   | 热情                     |
| ボルト[0][1]                            | volt                      | 伏特                     |
| ポルノ（グラフィー）[1]（[4]）          | pornography               | 色情作品                 |
| ホルモン[1]                             | （ドイツ）Hormon          | 荷尔蒙                   |
| ホルン[1]                               | horn                      | 圆号                     |
| ポロシャツ                              | polo shirt                | polo衫                   |
| ポロニウム[3]                           | polonium                  | 钋                       |
| ホワイト[2]                             | white                     |                          |
| ホワイトカラー[5]                       | white-collar              |                          |
| ホワイトハウス[5]                       | White House               |                          |
| ホワイトボード[5]                       | white board               |                          |
| ボンド[1]                               | bond                      | 胶水                     |
| ポンド[1]                               | （オランダ）pond          |                          |
| ポンプ[1]                               | （オランダ）pomp          | 泵                       |
|                                         |                           |                          |
...
| リード[1]                     | lead                    |                  |
| リーフ[1]                     | leaf                    |                  |
| リーフレット[1][4]            | leaflet                 | 传单             |
| リコール[2]                   | recall                  |                  |
| リサーチ[2]                   | research                | 研究，考察       |
| リザーブ[2]                   | reserve                 |                  |
| リサイクル[2]                 | recycle                 |                  |
| リスク[1]                     | risk                    | 风险             |
| リスト[1]                     | list                    |                  |
...
| リセット[2]                   | reset                   |                  |
| リゾート[2]                   | resort                  | 度假地           |
| リタイア[2]                   | retire                  | 弃权；退休，引退 |
| リチウム[2]                   | lithium                 | 锂               |
| リッチ[1]                     | rich                    |                  |
| リットル                      | （フランス）litre       |                  |
| リニューアル[2]               | renewal                 |                  |
| リハーサル[2]                 | rehearsal               | 彩排             |
| リバース[2]                   | reverse                 |                  |
| リバティー[1]                 | liberty                 |                  |
| リハビリ（テーション）（[5]） | rehabilitation          | 复健             |
| リパブリック[2]               | republic                |                  |
| リピート[2]                   | repeat                  |                  |
| リビング（ルーム）            | living room             |                  |
| リフォーム[2]                 | reform                  | 改衣服；室内翻修 |
| リフト[1]                     | lift                    |                  |
| リプレー[3]                   | replay                  |                  |
| リフレーン[3]                 | refrain                 |                  |
| リフレッシュ[3]               | refresh                 |                  |
...
| リモコン                      | remote + control        |                  |
| リユース[1]                   | reuse                   |                  |
| リュック（サック）[1]（[4]）  | （ドイツ）Rucksack      | 旅行背包         |
| リラックス[2]                 | relax                   |                  |
| リリース[2]                   | release                 |                  |
| リレー[2]                     | relay                   |                  |
| リン[1]                       | 燐                      | 磷               |
...
| レコーダー[2]                 | recorder                |                  |
| レコード[2]                   | record                  | 唱片；记录       |
| レジ（スター）[1]（[2][3]）   | register                | 收银台           |
| レシート[2]                   | receipt                 | 收据             |
| レシーバー[2]                 | receiver                |                  |
| レジスタンス[2][3]            | （フランス）résistance  | 抵抗，反抗       |
| レジデンス[1]                 | residence               |                  |
| レシピ[1]                     | recipe                  |                  |
| レジャー[1]                   | leisure                 |                  |
| レジューム[2]                 | resume                  |                  |
| レスキュー[1]                 | rescue                  |                  |
| レズ（ビアン）[1]             | les(bian)               | 女同性恋         |
| レスポンス[3][1]              | response                |                  |
| レスト[1]                     | rest                    |                  |
| レストラン[1]                 | restaurant              |                  |
| レター[1]                     | letter                  |                  |
...
| ロープウエイ[5]               | ropeway                 | 缆车             |
| ロール[1]                     | roll                    | 卷               |
| ロールケーキ[4]               | roll cake               | 瑞士卷           |
| ロールバック[4]               | rollback                |                  |
| ログ[1]                       | log                     |                  |
| ログアウト[3]                 | log out                 |                  |
| ログイン[3]                   | log in                  |                  |
| ロケ（ーション）[1]（[2]）    | location                | 外景拍摄         |
| ロケット[2]                   | rocket                  |                  |
| ロゴ[1]                       | logo                    |                  |
| ロジック[1]                   | logic                   |                  |
| ロスタイム[3]                 | loss + time             | 浪费时间         |
| ロッカー[1]                   | locker                  | 防盗置物柜       |
| ロック[1]                     | lock                    |                  |
| ロックアウト[4]               | lockout                 |                  |
| ロビー[1]                     | lobby                   |                  |
...
| ワン[1]               | one              |                                |
| ワンダー              | wonder           |                                |
| ワンダーランド[5]     | wonderland       | 游乐园                         |
| ワンダフル[1]         | wonderful        |                                |
| ワンチャン[3]         | one + chance     | 一线生机                       |
| ワンピース[3]         | one piece        | 连衣裙                         |
| ワンポイント[3]       | one point        |                                |
| ワンマン[1]           | one-man          |                                |
|                       |                  |                                |
