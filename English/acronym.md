...
| OTC   | over the counter (drugs)            | 非处方（药）       |
|       |                                     |                    |
| **P** |                                     |                    |
| PA    | personal assistant                  | （英）私人助理     |
| PC    | personal computer                   | 个人电脑           |
| PhD   | Doctor of Philosophy                | 博士               |
| PM    | (Latin) Post Meridiem               | 下午               |
...
| WC    | water closet                        | 厕所               |
| WFH   | work from home                      | 远程工作           |
| WIP   | work in progress                    | 进行中             |
| WLAN  | wireless local area network         | 局域网             |
|       |                                     |                    |
| **Y** |                                     |                    |
| YOLO  | you live only once                  | 你只活一次         |
|       |                                     |                    |
